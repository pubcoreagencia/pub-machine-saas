# MASTER CONTEXT — PUB Machine SaaS

**Identificador Canônico:** `pub-machine-saas`  
**Vertical:** Tecnologia  
...
Versão multi-tenant SaaS da PUB Machine para clientes externos.
...
- **Repositório GitHub:** `pubcoreagencia/pub-machine-saas`
